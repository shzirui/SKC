        ...
        if os.path.isdir(domain_path):
            for example_id in os.listdir(domain_path):
                ...
                if os.path.isdir(example_path):
                    if "traj.jsonl" in os.listdir(example_path):
                        ...
                        with open(os.path.join(example_path, "traj.jsonl"), "r") as f:
                            ...
                            for line in f:
                                ...
                                if data["done"]:
                                    domain_result[domain].append(1)
                                    has_done = True
                                    break
                            if not has_done:
                                domain_result[domain].append(0)
                        ...
                        try:
                            result = open(os.path.join(example_path, "traj.jsonl"), "r").read()
                            # try:
